...
function AdminScreen({navigation}) {
  ...
  async function getAllData() {
    axios.get('http://192.168.31.36:5001/get-all-user').then(res => {
  ...
  async function getData() {
    ...
    console.log(token);
    axios
      .post('http://192.168.31.36:5001/userdata', {token: token})
      .then(res => {
        console.log(res.data);
  ...
  function deleteUser(data) {
    axios
      .post('http://192.168.31.36:5001/delete-user', {id: data._id})
      .then(res => {
        console.log(res.data);
